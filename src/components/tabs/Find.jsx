...
import { GREEN, GOLD, GOLD_MUTED, SURFACE, BORDER, TEXT, TEXT2, TEXT3, F_SANS, F_UI } from "../../lib/theme.js";
    ...
    <div>
      ...
      {search.length >= 2 && (
        <div style={{ background: SURFACE, border: `1px solid ${BORDER}`, borderRadius: "12px", padding: "28px 24px", textAlign: "center" }}>
          ...
          <div style={{ fontFamily: F_SANS, fontSize: "20px", fontWeight: "700", color: GREEN, marginBottom: "8px" }}>Draw lookup coming soon</div>
